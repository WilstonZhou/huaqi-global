...
function footerHtml(p) {
  return '<footer class="site-footer" id="site-footer">\n' +
    ...
    '      <a href="' + p + 'country/sg">新加坡公司注册</a><a href="' + p + 'country/hk">香港公司注册</a><a href="' + p + 'country/us">美国公司注册</a><a href="' + p + 'country/my">马来西亚公司注册</a><a href="' + p + 'country/th">泰国公司注册</a><a href="' + p + 'country/uk">英国公司注册</a><a href="' + p + 'country/jp">日本公司注册</a><a href="' + p + 'country/kr">韩国公司注册</a><a href="' + p + 'country">全部国家 →</a>\n' +
    '    </div>\n' +
    '    <div class="footer-col"><h3>知识中心</h3>\n' +
    '      <a href="' + p + 'knowledge/singapore-registration-guide">2026 新加坡公司注册完全指南</a><a href="' + p + 'knowledge/us-company-tax-policy">美国公司税收政策解读</a><a href="' + p + 'knowledge/cross-border-compliance">跨境电商出海合规全方案</a><a href="' + p + 'knowledge/registration-cost-comparison">各国注册周期与费用对比</a><a href="' + p + 'knowledge/odi-vie-guide">ODI 备案与 VIE 架构指南</a><a href="' + p + 'knowledge/hk-vs-sg-company">香港 vs 新加坡公司对比</a><a href="' + p + 'knowledge/cayman-vs-bvi">开曼 vs BVI 离岸对比</a><a href="' + p + 'knowledge/overseas-bank-account-guide">海外银行开户指南</a><a href="' + p + 'news/index">政策动态</a>\n' +
    '    </div>\n' +
