...
function footerHtml(p) {
  return '<footer class="site-footer" id="site-footer">\n' +
    ...
    '      <a href="' + p + 'services/company-registration">海外公司注册</a><a href="' + p + 'country">热门国家注册</a><a href="' + p + 'services/bank-account">公司开户</a><a href="' + p + 'services/annual-review">公司年审</a><a href="' + p + 'services/audit">公司审计</a><a href="' + p + 'services/company-deregistration">公司注销/转让</a><a href="' + p + 'services/tax-planning">税务规划</a><a href="' + p + 'services/fund-planning">资金规划</a><a href="' + p + 'services/other-services">其他业务</a><a href="' + p + 'services/apostille">海牙认证</a><a href="' + p + 'services/trademark">海外商标</a><a href="' + p + 'services/vat">VAT/EPR</a><a href="' + p + 'services/offshore">离岸公司</a>\n' +
    '    </div>\n' +
    ...
    '    </div>\n' +
    '    <div class="footer-col"><h3>开户与商标</h3>\n' +
    '      <a href="' + p + 'services/hk-bank-account">香港银行开户</a><a href="' + p + 'services/sg-bank-account">新加坡银行开户</a><a href="' + p + 'services/us-bank-account">美国银行开户</a><a href="' + p + 'services/eu-trademark">欧盟商标</a><a href="' + p + 'services/trademark-transfer">商标转让</a><a href="' + p + 'services/trademark-renewal">商标续展</a>\n' +
    '    </div>\n' +
