...
const US = {
  start: '前身为会计事务所,2018 年发展至今',
  hq: '总部深圳,业务涉及深圳、广州、北京、上海、香港、新加坡、马来西亚、美国、英国、越南、泰国等',
  coverage: '全球 60 多个国家/地区均可办理',
  team: '300+ 专业团队',
...
module.exports = [
  {
    ...
    metaDesc: '华企环球与万企帮的公开信息对比:起步与布局、覆盖国家、服务范围、资质与服务模式。信息取自双方官网自述,仅作客观罗列,不构成优劣评价,供选型时对照参考。',
  ...
  },
  {
    ...
    metaDesc: '华企环球与唐诚控股的公开信息对比:总部与网点布局、覆盖国家、服务范围、资质与服务模式。信息取自双方官网自述,仅作客观罗列,不构成优劣评价,供选型时对照参考。',
  ...
  },
  {
    ...
    metaDesc: '华企环球与小牛国际的公开信息对比:起步年份、覆盖国家、服务范围、持牌资质与服务模式。信息取自双方官网自述,仅作客观罗列,不构成优劣评价,供选型时对照参考。',
