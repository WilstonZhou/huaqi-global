...
var solutions = [
  ...
  },
  {
    ...
    metaDesc: '华企环球制造业出海建厂方案:泰国 BOI、越南 IRC/ERC、印尼 PT PMA,外资准入评估、工厂许可、环评、税务与审计一站式落地。覆盖选址评估到投产后的持续合规。',
  ...
  },
  {
    ...
    metaDesc: '华企环球 VIE/红筹架构方案:开曼/BVI/香港主体搭建、ODI 备案、37 号文登记、税务架构规划,为境外融资与上市铺路。适用于境外融资、红筹上市与股权激励安排。',
  ...
  },
  {
    ...
    metaDesc: '华企环球身份与资产规划方案:马来西亚第二家园、留学移民、海外资产配置与身份税务联动,为企业主与高净值家庭提供一站式规划。可按家庭情况定制方案,并衔接公司架构与税务安排。',
