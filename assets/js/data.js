...
window.HQ_DATA = {
  ...
  features: [
    {
      ...
      title: 'AI 智能企服匹配引擎',
      tagline: '3 分钟出方案',
      desc: '对话式交互引导需求,AI 自动识别服务组合,生成个性化方案(含费用区间、办理周期、材料清单)。',
      link: 'ai-match.html',
      highlight: true
    },
    {
      ...
      title: '透明化定价与方案配置器',
      tagline: '明码标价 拒绝隐形消费',
      desc: '所有服务价格、周期、所需材料公开透明,购物车式勾选实时算价,一键生成可下载方案书。',
      link: 'services/company-registration.html#pricing',
      highlight: false
    },
    {
      id: 'tracking',
  ...
  aiMatch: {
    sampleDialog: [
      ...
      { role: 'ai', text: '基于您的需求,我推荐以下方案(总预估 ¥21,400,周期 6-8 周):\n1) 新加坡 Pte Ltd 注册 ¥8,800\n2) 新加坡 DBS 银行开户 ¥5,800\n3) 欧盟 VAT 注册(若销欧)¥3,800\n4) 商标注册(新加坡+马德里)¥3,000\n是否需要加急?或转人工顾问深度沟通?' }
    ],
    scenarios: [
  ...
  faq: [
    ...
    { q: '价格是否透明?有无隐形消费?', a: '华企环球承诺明码标价,标准化服务(注册/年审/开户)显示固定价,复杂服务(架构/ODI)显示区间价与影响因素。所有费用在合同中明确列出。' },
